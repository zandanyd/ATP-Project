...
public class Maze implements Serializable {
    ...
    public byte[] toByteArray(){
        ...
        double cellsForColumns = Math.ceil(this.m_columns / 255);
        double cellsForRows = Math.ceil(this.m_rows / 255);
        for(int i = 0; i < cellsForRows; i++){
            newByteArr.add((byte)255);
        }
        newByteArr.add((byte) (this.m_rows % 255) );
